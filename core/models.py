...
class AbstractModel(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True, verbose_name='oluşturulma tarihi', help_text='')
...
class GeneralSettinModel(AbstractModel):
    ...
    description = models.TextField(verbose_name='açıklama', help_text='', blank=True, default='')
    parameter = models.CharField(max_length=255, verbose_name='parametre', help_text='', blank=True, default='')
...
class ImageModel(AbstractModel):
    name = models.CharField(max_length=100, verbose_name='isim', help_text='', blank=True, default='')
    image = models.ImageField(storage=ImageSettingStorage(), verbose_name='resim', help_text='', blank=True, default='')
    ...
    def image_tag(self):
        if self.image:
            return mark_safe(f'<img src="{self.image.url}" style="border-radius:50px;" height="50"/>')
        else:
            return ""
...
class SkillModel(AbstractModel):
    ...
    name = models.CharField(max_length=100, verbose_name='isim', help_text='', blank=True, default='')
    description = models.TextField(verbose_name='açıklama', help_text='', blank=True, default='')
    percent = models.IntegerField(default=50, validators=[MinValueValidator(0), MaxValueValidator(100)],
                                  verbose_name='yüzde')
    skiltype = models.ForeignKey(SkillTypeModel, on_delete=models.CASCADE, verbose_name='skill tipi', help_text='',
...
class Document(AbstractModel):
    ...
    document = models.FileField(storage=DocumentStorage(), verbose_name='dosya', help_text='', blank=True, default='')
...
class Messages(AbstractModel):
    objects = None
    name = models.CharField(max_length=100, verbose_name='isim', help_text='', blank=True, default='')
    email = models.EmailField(verbose_name='email', help_text='', blank=True, default='')
    subject = models.CharField(max_length=100, verbose_name='konu', help_text='', blank=True, default='')
    message = models.TextField(verbose_name='mesaj', help_text='', blank=True, default='')
