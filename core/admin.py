...
from .models import GeneralSettinModel,ImageModel,SkillModel,SkillTypeModel,SocialModel,Document,Messages

@admin.register(GeneralSettinModel)
class GeneralSettingAdmin(admin.ModelAdmin):
    list_display = ['id','name','parameter','description','updated','created',]
...
class ImageModelAdmin(admin.ModelAdmin):
    list_display = ['id','name','image_tag','updated','created',]
...
class SocialModelAdmin(admin.ModelAdmin):
    list_display = ['id','link','icon','updated','created',]
...
class DocumentAdmin(admin.ModelAdmin):
    list_display = ['id','order','document','slug','document_text','updated','created',]
    list_filter = ['id','slug','updated','created']
    search_fields = ['id','slug','updated','created']
    list_editable = ['slug','order','document','document_text',]
    prepopulated_fields = {'slug':('slug',)}

@admin.register(Messages)
class MessagesAdmin(admin.ModelAdmin):
    list_display = ['id','name','email','subject','message','updated','created',]
